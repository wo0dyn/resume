...
\begin{center}
	...
	{\titlefont\hspace{2cm}@wo0dyn, 36 ans, développeur web\footnote{\sf
        Les références pour mes différents postes ou les dissertations
        sont disponibles sur demande.}, expert e-commerce}
\end{center}
...
\begin{description}
    ...
    \job{Oscaro}{télétravail, Gennevilliers}{91}{CDI}{depuis Avril 2014}{
