...
% \usepackage{lmodern, aeguill, xspace}
\usepackage{aeguill, xspace}
\usepackage[american, francais]{babel}
\usepackage{graphicx, fancyhdr}
\usepackage{amsmath, amsfonts, amssymb, marvosym, textcomp}
\usepackage{vmargin}
\usepackage{url}
...
% \cfoot{}
% note : pour ne pas avoir les numéros de page.
...
% % % % \mySubsection*{\hspace{5mm}$\blacklozenge$\textsf{#1}}%
% % % % }
...
% % --------------------------- Redéfinition des footnotetexts :
% \let\myFootnotetext\footnotetext
% \renewcommand{\footnotetext}[2]{%
% \myFootnotetext[#1]{\textsf{#2}}%
% }
...
%{\bfseries Coordonnées}\dotfill&455 route de Vignarnaud{} - 82000 MONTAUBAN\\
%	&Tél. $\mathsf{06\cdot15\cdot31\cdot64\cdot04}$\\
...
%J'ai d'autres stages à mon actif, notamment au LORIA.\\\hspace*{-5mm}
%Le nom des encadrants et les dissertations sont disponibles sur simple demande.
...
% \begin{description}
% 	\workItem{Mekrom Engineering}{Lugano}{Suisse}{Freelance}{Septembre--Octobre 2005}
%         {Développement d'un site dynamique multilingue avec interface de maintenance.
%         \website{http://www.mekrom.eu}}
%         \workItem{MJC Lorraine}{Vando{\oe}uvre-lès-Nancy}{54}{Freelance}{Août--Septembre 2004}
%         {Mise en place d'une plateforme PHP/MySQL avec interface de maintenance.
%         \website{http://www.mjclorraine.com}}
%         \workItem{Subtran/Technotol/Tecnolak}{Pompey}{54}{Freelance}{Septembre--Octobre 2003}
%         {Développement de sites dynamiques multilingues avec interface de maintenance pour la société Subtran et
%         ses deux filiales Technotol et Tecnolak.
%         \website{http://www.{subtran, technotol, tecnolak}.com}}
% \end{description}
...
\begin{description}
        ...
        % \item{Serveurs : }Apache/nginx, SSH, CVS/SVN, SaMBa ;
